...
*/
let skills = ['html', 'css', 'no javascript']
me.skills = skills
//console.log(me)
/* ESERCIZIO F
  Crea un pezzo di codice per aggiungere un nuovo elemento all'array "skills" contenuto nell'oggetto "me".
*/
let newSkills = 'call of duty'
...
//console.log(whoIsBigger(5, 8)) return b
//console.log(whoIsBigger(9, 8)) return a
/* ESERCIZIO 3
...
//console.log(isThisAnEmail('acquarius33@gmail.com')) true
//console.log(isThisAnEmail('acquarius33@gmail-com')) false
...
function searchByTitle(a) {
  let filtra = movies.filter(movie => movie.Title.toLowerCase().includes(a.toLowerCase()))
  return filtra
}
...
*/
function selezionaretuttitd() {
  let td = document.getElementsByTagName('td')
  
}
//console.log(selezionaretuttitd())
  
/* ESERCIZIO 22
  Scrivi una funzione che, tramite un ciclo, stampa in console il testo contenuto in ogni tag <td> all'interno della pagina.
*/
function stampaTD() {
  let TD = selezionaretuttitd()
